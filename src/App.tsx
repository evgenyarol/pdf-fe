...
function App() {
  ...
  const on2FormFinish = async (formData: any) => {
    await fetch("http://localhost:3001/pdf/receiving", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  return (
    <div className="container">
      <Form name="form1" onFinish={on1FormFinish} className="column">
        ...
        <Form.Item name="secondAddress" label="Второй Адрес">
          <Input placeholder="Второй Адрес" />
        </Form.Item>
        <Form.Item name="startDateSecond" label="Срок регистрации с">
          <Input placeholder="DD.MM.YYYY" />
        </Form.Item>
        <Form.Item name="stopDateSecond" label="Срок регистрации по">
          <Input placeholder="DD.MM.YYYY" />
        </Form.Item>
        <Form.Item name="threeAddress" label="Третий Адрес">
          <Input placeholder="Третий Адрес" />
        </Form.Item>
        <Form.Item name="startDateThree" label="Срок регистрации с">
          <Input placeholder="DD.MM.YYYY" />
        </Form.Item>
        <Form.Item name="stopDateThree" label="Срок регистрации по">
          <Input placeholder="DD.MM.YYYY" />
        </Form.Item>

        <Form.Item name="wordDocument" valuePropName="checked">
          <Checkbox>Документ Ворд</Checkbox>
        </Form.Item>
      ...
      <Form name="form2" onFinish={on2FormFinish} className="column">
        ...
        <Form.Item name="documentSeries" label="Серия документа">
